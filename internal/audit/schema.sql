...
CREATE TABLE IF NOT EXISTS audit_policies (id TEXT PRIMARY KEY, name TEXT NOT NULL, alias TEXT UNIQUE NOT NULL, enabled BOOLEAN NOT NULL DEFAULT TRUE, draft JSONB NOT NULL, draft_revision BIGINT NOT NULL DEFAULT 1, active_version INTEGER NOT NULL DEFAULT 0);
CREATE TABLE IF NOT EXISTS audit_policy_versions (policy_id TEXT NOT NULL REFERENCES audit_policies(id), version INTEGER NOT NULL, config JSONB NOT NULL, author TEXT NOT NULL, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), PRIMARY KEY(policy_id, version));
...
CREATE TABLE IF NOT EXISTS audit_costs (
 request_id TEXT PRIMARY KEY, client_id TEXT NOT NULL, kind TEXT NOT NULL, policy_id TEXT NOT NULL,
 policy_version INTEGER NOT NULL, model TEXT NOT NULL, price_id BIGINT REFERENCES model_prices(id),
...
CREATE TABLE IF NOT EXISTS cost_adjustments (
 id BIGSERIAL PRIMARY KEY, request_id TEXT NOT NULL REFERENCES audit_costs(request_id),
